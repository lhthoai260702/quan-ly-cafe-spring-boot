...
public class HomeController {
    ...
    public String home(Model model) {
        ...
        int donHangHomNay = hoaDonsToday.size();
        ...
        // 5. Hoạt động gần đây (Lấy 5 hóa đơn thanh toán mới nhất trong ngày)
        List<HoaDon> hoatDongGanDay = new ArrayList<>(hoaDonsToday);
        Collections.reverse(hoatDongGanDay);
