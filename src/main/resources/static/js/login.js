/**
 * Khởi tạo icon Lucide cho toàn bộ trang
 */
...
/**
 * Lắng nghe sự kiện khi cây DOM đã tải hoàn tất để gắn validation form
 */
    ...
    forms.forEach(function (form) {
        ...
        form.addEventListener('submit', function (e) {
            ...
            if (!isValid) {
                ...
                // Logic mới: Ẩn thông báo server khi bấm submit mà form có lỗi client
